...
|---------|---------------|
| **@aruct/core** | Node schemas, scene state (Zustand), systems (geometry generation), spatial queries, event bus |
| **@aruct/viewer** | 3D rendering via React Three Fiber, default camera/controls, post-processing |
