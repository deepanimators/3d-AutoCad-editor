---
name: open-pr
description: Open a pull request on aruct/editor using the repo's PR template. Use when the user asks to open/create a PR, push and PR, or ship a branch in the editor repo.
allowed-tools: Bash(git *) Bash(gh *) Read
---

Open a pull request against `aruct/editor` from the current branch.
